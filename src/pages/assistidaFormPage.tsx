...
import { PanicLinkCard } from '../components/PanicLinkCard';
...
export function AssistidaFormPage() {
  ...
  return (
    <Stack spacing={2}>
      ...
      {/* Botão de pânico — só mostra ao editar uma assistida já cadastrada */}
      {isEdit && id && (
        <PanicLinkCard
          assistidaId={id}
          nomeAssistida={nomeCompleto || 'Assistida'}
          guarnicaoNome={guarnicaoPmp}
