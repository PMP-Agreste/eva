...
import AlertasPanicoPage from "./pages/AlertasPanicoPage";
...
export function App() {
  return (
    <Routes>
      ...
      <Route path="/alertas/panico" element={<RequireGestor><AppShell><AlertasPanicoPage /></AppShell></RequireGestor>} />
